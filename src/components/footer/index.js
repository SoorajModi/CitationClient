    ...
    <footer className="text-center lg:text-left bg-gray-100 text-gray-600">
      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <h6 className="uppercase font-semi-bold mb-4 flex justify-center md:justify-start">Links</h6>
            <p className="mb-4">
          ...
          <div>
            <h6 className="uppercase font-semi-bold mb-4 flex justify-center md:justify-start">Contact</h6>
      ...
      <div className="text-center p-6 bg-gray-200">
        ...
        <a className="text-gray-600 font-semi-bold" href="https://tailwind-elements.com/">Sooraj Modi</a>
      </div>
    </footer>
  );
}
